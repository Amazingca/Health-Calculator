...
class MainWindow(QMainWindow):
    def __init__(self, profile_name):
        ...
        self.mineral_calcium = QPlainTextEdit("Calcium: " + str(self.calc_target_mineral_calcium()) + " mg")
        self.mineral_calcium.setReadOnly(True)
        self.mineral_chloride = QPlainTextEdit("Chloride: " + str(self.calc_target_mineral_chloride()) + " g")
        self.mineral_chloride.setReadOnly(True)
        self.mineral_chromium = QPlainTextEdit("Chromium: " + str(self.calc_target_mineral_chromium()) + " mcg")
        self.mineral_chromium.setReadOnly(True)
        self.mineral_copper = QPlainTextEdit("Copper: " + str(self.calc_target_mineral_copper()) + " mcg")
        self.mineral_copper.setReadOnly(True)
        self.mineral_fluoride = QPlainTextEdit("Fluoride: " + str(self.calc_target_mineral_fluoride()) + " mg")
        self.mineral_fluoride.setReadOnly(True)
        self.mineral_iodine = QPlainTextEdit("Iodine: " + str(self.calc_target_mineral_fluoride()) + " mcg")
        self.mineral_iodine.setReadOnly(True)
        self.mineral_iron = QPlainTextEdit("Iron: " + str(self.calc_target_mineral_iron()) + " mg")
        self.mineral_iron.setReadOnly(True)
        self.mineral_magnesium = QPlainTextEdit("Magnesium: " + str(self.calc_target_mineral_magnesium()) + " mg")
        self.mineral_magnesium.setReadOnly(True)
        self.mineral_manganese = QPlainTextEdit("Manganese: " + str(self.calc_target_mineral_manganese()) + " mg")
        self.mineral_manganese.setReadOnly(True)
        self.mineral_molybdenum = QPlainTextEdit("Molybdenum: " + str(self.calc_target_mineral_molybdenum()) + " mcg")
        self.mineral_molybdenum.setReadOnly(True)
        self.mineral_phosphorous = QPlainTextEdit("Phosphorous: " + str(self.calc_target_mineral_phosphorous()) + " mg")
        self.mineral_phosphorous.setReadOnly(True)
        self.mineral_potassium = QPlainTextEdit("Potassium: " + str(self.calc_target_mineral_potassium()) + " g")
        self.mineral_potassium.setReadOnly(True)
        self.mineral_selenium = QPlainTextEdit("Selenium: " + str(self.calc_target_mineral_selenium()) + " mcg")
        self.mineral_selenium.setReadOnly(True)
        self.mineral_sodium = QPlainTextEdit("Sodium: " + str(self.calc_target_mineral_sodium()) + " mg")
        self.mineral_sodium.setReadOnly(True)
        self.mineral_zinc = QPlainTextEdit("Zinc: " + str(self.calc_target_mineral_sodium()) + " mg")
